...
clip="${1:?usage: run_a1_extended_post_retry_one.sh CLIP SEGMENTS_JSON}"
segment="${2:?usage: run_a1_extended_post_retry_one.sh CLIP SEGMENTS_JSON}"
...
log="${project}/signal4d/logs/legacy_a1_extended_post_v1/${clip}_retry.log"
...
echo "Completed retry ${clip}: ${result_count} total ensemble result files" >>"${log}"
